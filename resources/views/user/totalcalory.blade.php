    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <!-- Log out               -->
                <div class="list-inline-item logout">                   <a id="logout" href="login.blade.php" class="nav-link">Logout <i class="icon-logout"></i></a></div>
            </div>
        </div>
    </nav>
</header>
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="forms.blade.php"> <i class="icon-padnote"></i>Forms </a></li>
            ...
            <div class="block">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($k as $k)
                            <tr>
                                ...
                                <input type="hidden" value ="{{$g=$g+$k['energy']}}">;
                                <input type="hidden" value ="{{$q=$q+$k['protein']}}">;
                                <input type="hidden" value ="{{$w=$w+$k['carbohydrate']}}">;
                                <input type="hidden" value ="{{$r=$r+$k['fat']}}">;
                                <input type="hidden" value ="{{$t=$t+$k['sugar']}}">;
                                @endforeach
                        ...
                        @foreach($i as $i)
                            <tr>
                                ...
                                <td>{{$i['fat']}}</td>
                                <td>{{$i['sugar']}}</td>
                                <input type="hidden" value ="{{$g=$g+$i['energy']}}">;

                                <input type="hidden" value ="{{$q=$q+$i['protein']}}">;
                                <input type="hidden" value ="{{$w=$w+$i['carbohydrate']}}">;
                                <input type="hidden" value ="{{$r=$r+$i['fat']}}">;
                                <input type="hidden" value ="{{$t=$t+$i['sugar']}}">;
                                @endforeach
                        ...
                        @foreach($a as $a)
                            <tr>
                                ...
                                <input type="hidden" value ="{{$g=$g+$a['energy']}}">;
                                <input type="hidden" value ="{{$q=$q+$a['protein']}}">;
                                <input type="hidden" value ="{{$w=$w+$a['carbohydrate']}}">;
                                <input type="hidden" value ="{{$r=$r+$a['fat']}}">;
                                <input type="hidden" value ="{{$t=$t+$a['sugar']}}">;
                                @endforeach
                        ...
                        @foreach($b as $b)
                            <tr>
                                ...
                                <td>{{$b['protein']}}</td>
                                <td>{{$b['carbohydrate']}}</td>

                                <td>{{$b['fat']}}</td>
                                <td>{{$b['sugar']}}</td>

                                <input type="hidden" value ="{{$g=$g+$b['energy']}}">;
                                <input type="hidden" value ="{{$q=$q+$b['protein']}}">;
                                <input type="hidden" value ="{{$w=$w+$b['carbohydrate']}}">;
                                <input type="hidden" value ="{{$r=$r+$b['fat']}}">;
                                <input type="hidden" value ="{{$t=$t+$b['sugar']}}">;
                                @endforeach
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td>total energy:{{$g}} </td>
                            <td>total protein:{{$q}}</td>
                            <td>total carbohydrate:{{$w}}</td>
                            <td>total fat:{{$r}}</td>
                            <td>total solt:{{$t}}</td>
                    ...
                    @if($g<2600)
                        ...
                        <h1 style="color:red;">You need more calory from the next day</h1>

                        @elseif($g>2200 &&$g<2600)
                        <h1 style="color:red">you have taken sufficient food</h1>

                        @else
                        <h1 style="color:red">you have taken too much energy as your health need</h1>
                        @endif
