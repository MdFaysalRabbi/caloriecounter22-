    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <!-- Log out               -->
                <div class="list-inline-item logout"><a id="logout" href="" class="nav-link">Logout <i
...
<div class="d-flex align-items-stretch">
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">select option category</a></li>
        ...
        <section class="no-padding-top">
            <div class="container-fluid">
              ...
              <h1>ADMIN CHOOSE CATEGORY</h1>

                <div class="line"></div>
                <p class="form-group row">
                <p class="col-sm-9 ml-auto">
                <p> <button type="submit" class="btn btn-secondary"><a href="/bb">morning</a></button></p>
                <p> <button type="submit" class="btn badge-info"><a href="/bb1">noon</a></button></p>
                <p><button type="submit" class="btn btn-group"><a href="/bb2">evening</a></button></p>
                <p> <button type="submit" class="btn badge-success"><a href="/bb3">dinner</a></button></p>
            </div>
