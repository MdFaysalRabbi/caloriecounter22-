    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <!-- Log out               -->
                <div class="list-inline-item logout"> <a id="logout" href="/ll" class="nav-link">Logout <i class="icon-logout"></i></a></div>
            </div>
        </div>
    </nav>
</header>
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="totalcalory.blade.php"> <i class="fa fa-bar-chart"></i>total calory </a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="block">
                            ...
                            <div class="block-body">
                                <form class="" action="/xc" method="post" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="exname" class="form-control mb-3 mb-3">
                                ...
                                <div class="form-group row has-danger">
                                    <label class="col-sm-3 form-control-label">Excercise in  minutes</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="exhour" class="form-control is-valid">
                                    </div>
                                ...
                                <div class="form-group row has-success">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="weight"class="form-control is-valid">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row has-danger">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="height" class="form-control is-valid">
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 form-control-label">Select</label>
                                <div class="col-sm-9">
                                    <select name="inch" class="form-control mb-3 mb-3">
                                        <option >height with inch</option>
