                    ...
                    <div class="col-lg-12">
                        <div class="block">
                            ...
                            <div class="block-body">
                                <form class="" action="/dn1" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="email" value={{$h}} class="form-control is-valid">
                                    ...
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="gender" value="{{$l}}" class="form-control is-valid">
                                        </div>
                                    ...
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="time" name="time" class="form-control is-valid">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="kkk" class="form-control mb-3 mb-3">

                                                @foreach($value as $val)
                                                    <option value="{{$val['id']}}">{{$val['foodname']}}</option>
