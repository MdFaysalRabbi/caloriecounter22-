              ...
              <div class="col-lg-12">
                <div class="block">
                  ...
                  <div class="block-body">
                    <form class="" action="/st" method="post" enctype="multipart/form-data">
                       @csrf
                      ...
                      <div class="form-group row has-success">
                        <label class="col-sm-3 form-control-label">FOOD NAME</label>
                        <div class="col-sm-9">
                          <input type="text" name="foodname" class="form-control is-valid">
                        </div>

                      </div>

                        <div class="form-group row has-success">
                            <label class="col-sm-3 form-control-label">food image</label>
                            <div class="col-sm-9">
                      ...
                      <div class="form-group row has-danger">
                        <label class="col-sm-3 form-control-label">Energy of food</label>
                          <div class="col-sm-9">
                              <input type="text" name="energy" class="form-control is-valid">
                          </div>
