                    ...
                    <!-- Form Elements -->
                                    ...
                                    <p class="form-group row">
                                        <p class="col-sm-9 ml-auto">
                                            <p> <button type="submit" class="btn btn-secondary"><a href="/mn">morning</a></button></p>
                                           <p> <button type="submit" class="btn badge-info"><a href="/nn">noon</a></button></p>
                                        <p><button type="submit" class="btn btn-group"><a href="/ev">evening</a></button></p>
                                      <p> <button type="submit" class="btn badge-success"><a href="/dn">dinner</a></button></p>
                                        </div>
