...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="tables.blade.php"> <i class="icon-grid"></i>Tables </a></li>
            <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>Charts </a></li>
            <li class="active"><a href="forms.blade.php"> <i class="icon-padnote"></i>Forms </a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="block">
                            ...
                            <div class="block-body">
                                <form class="" action="/en" method="post" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <div class="form-group row has-success">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="foodid" value="{{$id}}" class="form-control is-valid">
                                </div>
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row has-success">
                                        <label class="col-sm-3 form-control-label">PROTEIN</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="protein" class="form-control is-valid">
                                        </div>
                            ...
                            <div class="line"></div>
                            <div class="form-group row has-success">
                                <label class="col-sm-3 form-control-label">CARBOHYDRATE</label>
                                <div class="col-sm-9">
                                    <input type="text" name="carbohydrate" class="form-control is-valid">
                                </div>
                            ...
                            <div class="line"></div>
                            <div class="form-group row has-success">
                                <label class="col-sm-3 form-control-label">FAT</label>
                                <div class="col-sm-9">
                                    <input type="text" name="fat" class="form-control is-valid">
                                </div>
                            ...
                            <div class="line"></div>
                            <div class="form-group row has-success">
                                <label class="col-sm-3 form-control-label">SUGAR</label>
                                <div class="col-sm-9">
                                    <input type="text" name="sugar" class="form-control is-valid">
                                </div>
